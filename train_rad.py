...
from data.vqarad_dataset import VQA_dataset
...
def main(args, config):
    ...
    datadir = r'/VQA_RAD_Image_Folder'
    train_labeldir = r'/VQA_RAD/train.jsol'
    test_labeldir = r'/VQA_RAD/test.jsol'
    train_datasets = VQA_dataset(data_dir=datadir,label_dir=train_labeldir,transform=transform_train) 
    test_datasets = VQA_dataset(data_dir=datadir, label_dir= test_labeldir, transform= transform_train)
    ...
    result_file = save_result(vqa_result, args.result_dir, 'vqa_result_jy_instruction_FT_checkpoint129')  
        #result_file = save_result(vqa_result, args.result_dir, 'vqa_trainresult')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--config', default='/miss-main/configs/vqa.yaml') 
